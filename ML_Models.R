...
df <- read.csv("C:\\Users\\CHHAYA SINGH\\Desktop\\R Files\\titanic.csv")
View(df)
...
# clipping at 88% tile
df$fare <- ifelse(df$fare>=69.5,69.5,df$fare)
...
# mtry = no of features to select(max_features)
